...
public:
    ShaderDepth()
        : Shader(EXAMPLE_CUR_PATH + "shader/depth.vert", EXAMPLE_CUR_PATH + "shader/depth.frag")
    {
...
public:
    ShaderPcss()
        : Shader(EXAMPLE_CUR_PATH + "shader/pcss.vert", EXAMPLE_CUR_PATH + "shader/pcss.frag")
    {
        this->uniform_attrs_location_init();
    }
