...
public:
    ShaderPrefilterEnvMap() : Shader(cur_shader + "cube-map-common.vert", cur_shader + "prefilter-env-map.frag")
    {
...
public:
    ShaderEnvMap() : Shader(cur_shader + "cube-map-common.vert", cur_shader + "env-map.frag")
    {
        this->uniform_attrs_location_init();
    }
...
{
public:
    ShaderIntBRDF() : Shader(cur_shader + "square-common.vert", cur_shader + "int-brdf.frag") {}
...
public:
    ...
    ShaderIBL() : Shader(cur_shader + "common.vert", cur_shader + "ibl.frag") { this->uniform_attrs_location_init(); }
