...
const std::string CUR = EXAMPLES + "/cube-shadow-mapping/";
...
public:
    ...
    ShaderDepth()
        : Shader(CUR + "shader/distance-to-light.vert", CUR + "shader/distance-to-light.frag")
    {
...
public:
    ...
    ShaderShadowMapping()
        : Shader(CUR + "shader/shadow-mapping.vert", CUR + "shader/shadow-mapping.frag")
    {
        this->uniform_attrs_location_init();
    }
};
